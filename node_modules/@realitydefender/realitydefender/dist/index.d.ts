...
import { DetectionResult, DetectionResultList, GetResultOptions, RealityDefenderConfig, SocialUploadOptions, UploadOptions, UploadResult } from './types';
/**
...
export declare class RealityDefender extends TypedEventEmitter {
     ...
     * @returns Promise with the request ID
     */
    uploadSocialMedia(options: SocialUploadOptions): Promise<UploadResult>;
    /**
