...
const social_1 = require("./detection/social");
/**
...
class RealityDefender extends events_1.TypedEventEmitter {
     ...
     * @returns Promise with the request ID
     */
    async uploadSocialMedia(options) {
        try {
            // Upload the file and get tracking IDs
            return await (0, social_1.uploadSocialMediaLink)(this.client, options);
        }
        catch (error) {
            if (error instanceof errors_1.RealityDefenderError) {
                throw error;
            }
            throw new errors_1.RealityDefenderError(`Social media link upload failed: ${error.message}`, 'upload_failed');
        }
    }
    /**
